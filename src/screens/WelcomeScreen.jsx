...
const WelcomeScreen = ({ onNext }) => {
  ...
  const currentGalaIndex = Math.abs(galaPage % galaImages.length);
        ...
        <div id="experiences" className="summit-features-grid">
          ...
          <div className="mini-carousel-container">
            <AnimatePresence mode="wait">
              <motion.img
                key={`gala-${galaPage}`}
                src={galaImages[currentGalaIndex]}
            ...
            <div className="mini-carousel-caption">
              <div className="ed-icon prof-gold mini-icon"><Crown size={32} /></div>
      ...
      <section className="hero-section">
        ...
        <header className="top-nav">
          ...
          <nav className="nav-links glass-strip-nav">
            ...
            <button className="nav-btn-link" onClick={() => setShowCommittee(true)}>COMMITTEE</button>
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              ...
              >
                ...
                <button className="mobile-nav-btn" onClick={() => { setShowCommittee(true); setIsMobileMenuOpen(false); }}>COMMITTEE</button>
